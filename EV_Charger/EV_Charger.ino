...
#include <SPI.h>
#define MY_RF24_CE_PIN 10             //Para RF-Nano
#define MY_RF24_CS_PIN 9              //Para RF-Nano
#include <MySensors.h>
#include <EmonLib.h>
...
void presentation()
{
  sendSketchInfo("EV_Charger", "RL_1.0");  // Send the sketch version information to the gateway and Controller
